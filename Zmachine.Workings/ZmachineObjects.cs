...
{
    internal class ZmachineObjects
    {
        private int objectTableStartLocation;
        private readonly int version;
        private byte[] memory;
        private ZmTextEncodingDecoding textDecoder;
        ...
        public ZmachineV4Object GetObject(ushort objectId)
        {
            ...
            var attributes = memory[startAttributes..endAttributes];            // First 6 bytes are the 

            var objectDetails = new ZmachineV4Object
            {
                ...
                PropertiesName = new ZmPropertyHeader(memory.Get2ByteValue(endAttributes + 6), memory, textDecoder).Name
            };
        ...
        public ZmachineObjects(int objectTableLocation, int version, byte[] memory, ZmTextEncodingDecoding textDecoder)
        {
