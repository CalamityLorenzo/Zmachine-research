...
{
    // we are modelling the machine it self
    ...
    public partial class Zmachine_v1
    {
        ...
        public ZMachineDetails HeaderDetails { get; set; }
        ...
        public Zmachine_v1(Stream storyData)
        {
            GameData = storyData;
            GameData.Position = 0;
        ...
        {
            this.HeaderDetails = new ZMachineDetails()
            {
                Version = Memory[0],
