...
namespace Zmachine.Workings.Machines
{
  
    public partial class Zmachine_v1
    {
        ...
        public void DumpDictionary()
        {
            ...
            var textDecoder = new ZmTextEncodingDecoding(abbreviations);

            var zDict = new ZMachineDictionary(this.HeaderDetails.Dictionary, Memory, textDecoder);
        ...
        public void DumpObjects()
        {
            ...
            var zObjs = new ZmachineObjects(this.HeaderDetails.ObjectTable, this.HeaderDetails.Version, Memory, textDecoder);
        ...
        {
            Console.WriteLine("==== DYNAMIC ==== (After header until...)");
