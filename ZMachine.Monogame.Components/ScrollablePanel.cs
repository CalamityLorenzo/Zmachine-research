...
{
    public interface IScrollablePanelContent : IDrawable, IUpdateable
    {
    ...
    // Hosts vertical scrolling content in a Scissor Rect rasteriser
    public class ScrollablePanel
    {
        ...
        {
            // Notice the scollbar dimensions are actually seperate.
            // IF the scrollbar goes, less recalculating to be done.
        ...
        public void Update(GameTime gameTime)
        {
            if (Content != null)
            {
                ...
                // Don't bother with mouse info unless we have content
                // TODO : Calcaulate how many hours it will be until I regret this decision.
