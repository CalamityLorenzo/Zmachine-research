...
namespace Zmachine.V2.Machines
{
    public partial class Zmachine_v2
    {
        ...
        public void DumpHeader()
        {
            ...
            Console.WriteLine($"Checksum:\t\t\t $1C\t:\t{Memory.Get2ByteValue(28)}\t:\t{Memory.Get2ByteValueHex(0x1C)}");
            Console.WriteLine($"Interpreter number:\t\t $1D\t:\t{Memory[30]}");
            Console.WriteLine($"Interpreter version:\t\t $1E\t:\t{Memory[31]}");


            Console.WriteLine($"Routines offset (div by 8):\t $28\t:\t{Memory[0x28]}\t:\t{Memory[0x28]:X}");
            Console.WriteLine($"Strings offset (div by 8):\t $2A\t:\t{Memory[0x2A]}\t:\t{Memory[0x2A]:X}");
